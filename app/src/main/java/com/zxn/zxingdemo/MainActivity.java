...
import com.zxn.zxingdemo.utils.CheckPermissionUtils;
import com.zxn.zxing.activity.CaptureActivity;
...
//                startActivityForResult(intent, REQUEST_CODE);
                ...
                break;
            case R.id.button5:
                intent = new Intent(MainActivity.this, CustomUIActivity.class);
                startActivityForResult(intent, REQUEST_CODE);
                break;
            default:
                break;
